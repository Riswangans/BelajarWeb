import { auth, db, storage } from './firebaseConfig';
        ...
        try {
            ...
            showError("Firebase tidak dapat diinisialisasi. Silakan cek konfigurasi.");
        }
        ...
        async function loadUserTestimonials() {
            ...
            try {
                ...
                totalTestimonials.textContent = userTestimonials.length;
        ...
        async function loadUserPurchases() {
            ...
            try {
                ...
                totalPurchases.textContent = userPurchases;
                
            } catch (error) {
                console.error("Error loading purchases:", error);
                // If no orders collection exists, use testimonials as proxy
                totalPurchases.textContent = userTestimonials.length;
            }
        }
